...
app.get('/auth/login', (req, res) => {
  ...
  const oneUpAuthUrl = `https://api.1up.health/connect/marketplace/marketplace?client_id=${CLIENT_ID}&redirect_uri=${BACKEND_URL}/auth/callback&state=${encodeURIComponent(redirectUri)}`;
